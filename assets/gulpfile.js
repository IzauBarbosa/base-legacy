...
const js = () =>
  gulp
    .src([
      './source/js/vendor/jquery-3.6.0.min.js',
      './source/js/vendor/*.js',
      './source/js/helpers/*.js',
      './source/js/components/atoms/*.js',
      './source/js/components/molecules/*.js',
      './source/js/components/organisms/*.js',
      './source/js/components/templates/*.js',
      './source/js/components/pages/*.js',
